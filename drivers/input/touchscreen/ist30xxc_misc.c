...
/* sysfs : sys */
static DEVICE_ATTR(debug_mode, S_IRUGO | S_IWUSR, NULL, ist30xx_debug_mode_store);
...
#if IST30XX_GESTURE
static DEVICE_ATTR(gesture, S_IRUGO | S_IWUSR, NULL, ist30xx_gesture_store);
#endif
...
static DEVICE_ATTR(report_rate, S_IRUGO | S_IWUSR, NULL, ist30xx_report_rate_store);
...
static DEVICE_ATTR(mode_secure, S_IRUGO | S_IWUSR, NULL, ist30xx_secure_mode_store);
