...
/* sysfs  */
static DEVICE_ATTR(fw_read, S_IRUGO | S_IWUSR, ist30xx_fw_read_show, NULL);
static DEVICE_ATTR(firmware, S_IRUGO | S_IWUSR, ist30xx_fw_status_show,
		   ist30xx_fw_store);
static DEVICE_ATTR(fw_sdcard, S_IRUGO | S_IWUSR, ist30xx_fw_sdcard_show, NULL);
static DEVICE_ATTR(version, S_IRUGO | S_IWUSR, ist30xx_fw_version_show, NULL);
#ifdef XIAOMI_PRODUCT
static DEVICE_ATTR(lockdown, S_IRUGO | S_IWUSR, ist30xx_lockdown_show, NULL);
static DEVICE_ATTR(config, S_IRUGO | S_IWUSR, ist30xx_config_show, NULL);
#endif
